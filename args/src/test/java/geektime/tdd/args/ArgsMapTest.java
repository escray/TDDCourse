...
public class ArgsMapTest {
    ...
    public void should_split_option_without_value() {
        Map<String, String[]> args = ArgsMap.toMap("-b");
    ...
    public void should_split_option_with_value() {
        Map<String, String[]> args = ArgsMap.toMap("-p", "8080");
    ...
    public void should_split_option_with_values() {
        Map<String, String[]> args = ArgsMap.toMap("-g", "this", "is", "a", "list");
    ...
    public void should_split_args_list_to_map() {
        Map<String, String[]> args = ArgsMap.toMap("-g", "this", "is", "a", "list", "-d", "1", "2", "-3", "5");
